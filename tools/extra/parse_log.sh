...
#grep 'Test net output #3' aux.txt | awk '{print $11}' > aux2.txt
...
# Generating
echo '#Iters Seconds TestLoss'> $LOG.test
paste aux0.txt aux4.txt aux1.txt aux2.txt | column -t >> $LOG.test
#paste aux0.txt aux4.txt aux2.txt | column -t >> $LOG.test
#rm aux.txt aux0.txt aux2.txt aux3.txt aux4.txt
