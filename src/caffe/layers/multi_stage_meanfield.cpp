...
#include "caffe/layers/meanfield_iteration_layer.hpp"
...
void MultiStageMeanfieldLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  std::cout<<"Forward_cpu @ MultiStageMeanfieldLayer:"<<std::endl;
  ...
  std::cout << bottom[1]->shape(0) <<std::endl;
  std::cout << bottom[1]->shape(1) <<std::endl;
  std::cout << bottom[1]->shape(2) <<std::endl;
  std::cout << bottom[1]->shape(3) <<std::endl;
  std::cout << bottom[2]->shape(0) <<std::endl;
  std::cout << bottom[2]->shape(1) <<std::endl;
  std::cout << bottom[2]->shape(2) <<std::endl;
  std::cout << bottom[2]->shape(3) <<std::endl;
  std::cout << top[0]->shape(0) <<std::endl;
  std::cout << top[0]->shape(1) <<std::endl;
  std::cout << top[0]->shape(2) <<std::endl;
  std::cout << top[0]->shape(3) <<std::endl;
